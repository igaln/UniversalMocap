 ...
 */
var unpackit = function(data) {
    if (!data || data.length < 4)
        return;

	console.log("length " + data.length);
    offset = 0;
    var msgtype = data.readUIntLE(0, offset += 6);
	console.log("Ok " +msgtype.toString(6));
    var nbytes = data.readUIntLE(offset, offset +=6);
...
module.exports = {unpack: unpackit};
